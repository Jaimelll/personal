...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference('Family.count') do
      post families_url, params: { family: { admin_user_id: @family.admin_user_id, employee_id: @family.employee_id, tipo_rela: @family.tipo_rela } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { admin_user_id: @family.admin_user_id, employee_id: @family.employee_id, tipo_rela: @family.tipo_rela } }
