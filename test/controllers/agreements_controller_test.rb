...
class AgreementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agreement" do
    assert_difference('Agreement.count') do
      post agreements_url, params: { agreement: { admin_user_id: @agreement.admin_user_id, employee_id: @agreement.employee_id, puesto: @agreement.puesto } }
    end
  ...
  test "should update agreement" do
    patch agreement_url(@agreement), params: { agreement: { admin_user_id: @agreement.admin_user_id, employee_id: @agreement.employee_id, puesto: @agreement.puesto } }
